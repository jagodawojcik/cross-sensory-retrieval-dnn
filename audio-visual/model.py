...
class TripletDataset(Dataset):
    def __init__(self, audio_embeddings, visual_embeddings):
        assert audio_embeddings.keys() == visual_embeddings.keys()
    ...
    def __getitem__(self, idx):
        ...
        positive_source = random.choice(['audio', 'visual'])
        ...
        negative_source = random.choice(['audio', 'visual'])
        negative = random.choice(self.audio_embeddings[negative_label] if negative_source == 'audio' else self.visual_embeddings[negative_label])
